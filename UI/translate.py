class RU:
    ...
    class Elements:
        ...
        check_updates = "Проверить наличие обновления"
        about_title = "Serpentine Launcher — информация"
        header = "Serpentine Launcher"
        description = "Информационная панель лаунчера"
        section_main = "Основное"
        lang_impl = "Язык реализации:"
        version = "Текущая версия:"
        auto_update = "Поддержка обновлений:"
        update_value = "автоматическая"
        off_auto_update = "Проверка отключена"
        section_platforms = "Поддерживаемые платформы"
        platforms = ["Vanilla", "Forge", "Fabric", "Quilt"]
        section_interface = "Особенности интерфейса"
        build_date = "Дата сборки: {build_date}"
        bug_report = "Если вы заметили баг или хотите предложить улучшение, сообщите разработчику."
...
<body>
    ...
    class Dialogs:
        ...
        need_update_for_app = "Найдено обновление '{version}'!\nВы хотите его установить?"
        this_latest_version = "У вас установлена последняя версия лаунчера!"
        this_latest_beta_version = "У вас установлена бета версия лаунчера!"
        error_check_latest = "Не удалось проверить наличие обновления!"
        error_check_updater = "'updater.exe' не найден!\nСкачать его?"
        need_close_all_for_update = ("Для обновления лаунчера требуется закрыть его, "
                                     "это приведет к закрытию всех клиентов, продолжить?")
        update_successfully_info = "Установка обновления завершена!"
        save_and_continue = "Сохранить и продолжить"
        hello_dialog_title = "Первая настройка"
        hello_header = "Добро пожаловать!"
        hello_description = "Этот мастер поможет вам быстро и удобно настроить лаунчер под свои предпочтения."
        language_title = "Выберите язык интерфейса:"
        behavior_title = "Выберите поведение лаунчера при запуске игры:"
        java_memory_title = "Укажите объем памяти Java:"
        finish_title = "Готово!"
        finish_message = "Настройка завершена. Приятного использования лаунчера!"
        back = "← Назад"
        next = "Далее →"
        need_ckip_settings = "Вы действительно хотите пропустить настройку лаунчера?"
        check_auto_update = "Авто-Проверка обновлений"
        allow_silent_update = "Тихая установка"
...
class EN:
    ...
    class Elements:
        ...
        installed_cores_title = "Installed Minecraft cores"
        search_placeholder = "Search..."
        update_cores_elements = "Update list"
        no_available_installed_cores = "No supported cores installed"
        install = "Install"
        reinstall = "Reinstall"
        ...
        about_title = "Serpentine Launcher — Information"
        header = "Serpentine Launcher"
        description = "Launcher information panel"
        section_main = "General"
        lang_impl = "Implementation language:"
        version = "Current version:"
        auto_update = "Update support:"
        update_value = "automatic"
        off_auto_update = "Update check disabled"
        section_platforms = "Supported platforms"
        platforms = ["Vanilla", "Forge", "Fabric", "Quilt"]
        section_interface = "Interface features"
        build_date = "Build date: {build_date}"
        bug_report = "If you find a bug or want to suggest an improvement, please contact the developer."
...
<body>
    ...
    class Dialogs:
        ...
        need_update_for_app = "Update '{version}' found!\nDo you want to install it?"
        this_latest_version = "You have the latest version of the launcher installed!"
        this_latest_beta_version = "You have the beta version of the launcher installed!"
        error_check_latest = "Couldn't check for updates!"
        error_check_updater = "'updater.exe 'not found!\nDownload it from the GitHub of this project!"
        need_close_all_for_update = ("To update the launcher, you need to close it,"
                                     "this will close all clients, continue?")
        update_successfully_info = "Update installation is complete!"
        save_and_continue = "save and continue"
        hello_dialog_title = "First setup"
        hello_header = "Welcome!"
        hello_description = "This wizard will help you quickly configure the launcher to suit your preferences."
        language_title = "Select interface language:"
        behavior_title = "Choose launcher behavior when the game starts:"
        java_memory_title = "Specify Java memory size:"
        finish_title = "All set!"
        finish_message = "Setup is complete. Enjoy using the launcher!"
        back = "← Back"
        next = "Next →"
        need_ckip_settings = "Do you really want to skip the launcher setup?"
        check_auto_update = "Auto-Check for updates"
        allow_silent_update = "Silent installation"
